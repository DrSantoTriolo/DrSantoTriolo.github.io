...
- **OpenAI (ChatGPT): stopped “ad-like” in-app promo messages (feature rollback) — Dec 8, 2025**
  ...
  - **Source:** ([theverge.com](https://www.theverge.com/news/839882/openai-chatgpt-ads-app-promo-messages-turned-off?utm_source=openai))
...
- **OpenAI compute buildout (via Oracle): schedule pushed out (project delay, not cancellation) — reported Dec 12, 2025**
  ...
  - **Source:** ([finance.yahoo.com](https://finance.yahoo.com/news/oracle-delays-data-center-projects-161422852.html?utm_source=openai))
...
- **OpenAI: hired Slack CEO Denise Dresser as Chief Revenue Officer — announced Dec 9, 2025**
  ...
  - **Ground-truth sources:** OpenAI announcement ([openai.com](https://openai.com/index/openai-appoints-denise-dresser?utm_source=openai)); Reuters ([reuters.com](https://www.reuters.com/business/openai-taps-slack-ceo-denise-dresser-chief-revenue-officer-2025-12-09/?utm_source=openai))
...
- **Google: appointed Amin Vahdat as chief technologist for AI infrastructure buildout — reported Dec 10, 2025**
  ...
  - **Source:** ([reuters.com](https://www.reuters.com/business/google-names-amin-vahdat-new-chief-ai-infrastructure-buildout-semafor-reports-2025-12-10/?utm_source=openai))
...
- **OpenAI: changed equity vesting policy to remove the 6‑month “cliff” for new hires — reported Dec 14, 2025**
  ...
  - **Source:** ([wsj.com](https://www.wsj.com/tech/ai/openai-ends-vesting-cliff-for-new-employees-in-compensation-policy-change-d4c4c2cd?utm_source=openai))
...
- **Meta: acquired AI device startup Limitless — announced Dec 5, 2025**
  ...
  - **Competitive advantages / unique details**
    ...
    - **Immediate product shutdown decisions:** Limitless said it will **stop selling hardware**, keep **support for a year**, end subscriptions (move customers to an “Unlimited Plan”), and **wind down** other functionality including non-pendant Rewind software—suggesting post-acquisition refocus and consolidation. ([techcrunch.com](https://techcrunch.com/2025/12/05/meta-acquires-ai-device-startup-limitless/?utm_source=openai))
  - **Source:** ([techcrunch.com](https://techcrunch.com/2025/12/05/meta-acquires-ai-device-startup-limitless/?utm_source=openai))

- **OpenAI: agreed to acquire Neptune (neptune.ai) — announced Dec 3, 2025**
  - **Acquired company focus / approach**
    - Neptune is an **experiment tracking + training monitoring** system used for **GPT-scale training**, oriented around high-cardinality metrics (including **per-layer** metrics) and fast visualization/debugging at scale. ([openai.com](https://openai.com/index/openai-to-acquire-neptune/?utm_source=openai))
  - **Competitive advantages / unique details**
    - **“Training observability” as leverage:** better visibility into training dynamics (compare thousands of runs, identify issues across layers) can reduce wasted GPU cycles and shorten iteration loops. ([openai.com](https://openai.com/index/openai-to-acquire-neptune/?utm_source=openai))
    - OpenAI states it plans to integrate Neptune **deep into its training stack** to expand visibility into how models learn. ([openai.com](https://openai.com/index/openai-to-acquire-neptune/?utm_source=openai))
  - **Sources:** OpenAI announcement ([openai.com](https://openai.com/index/openai-to-acquire-neptune/?utm_source=openai)); Neptune product positioning ([neptune.ai](https://neptune.ai/product?utm_source=openai)); Reuters report on the deal ([reuters.com](https://www.reuters.com/business/openai-agrees-acquire-ai-startup-neptune-boost-model-training-capabilities-2025-12-04/?utm_source=openai))

- **Anthropic: acquired Bun — reported/announced Dec 2–3, 2025**
  - **Acquired company focus / approach**
    - **Bun** is an all-in-one JavaScript/TypeScript toolkit (runtime + package manager + bundler + test runner), built for speed and “drop-in” Node.js compatibility. ([bun.com](https://bun.com/docs?utm_source=openai))
  - **Competitive advantages / unique details**
    - **Performance + developer-experience wedge:** fast runtime and fast dependency installs/testing can materially improve agentic coding throughput (Anthropic positioned it as accelerating **Claude Code**). ([reuters.com](https://www.reuters.com/business/media-telecom/anthropic-acquires-developer-tool-startup-bun-scale-ai-coding-2025-12-02/?utm_source=openai))
    - **Technical differentiation:** Bun’s docs describe it as written in **Zig** and powered by **JavaScriptCore** (Safari engine), aiming to reduce startup time and memory use. ([bun.com](https://bun.com/docs?utm_source=openai))
  - **Sources:** Reuters ([reuters.com](https://www.reuters.com/business/media-telecom/anthropic-acquires-developer-tool-startup-bun-scale-ai-coding-2025-12-02/?utm_source=openai)); Anthropic announcement ([anthropic.com](https://www.anthropic.com/news/anthropic-acquires-bun-as-claude-code-reaches-usd1b-milestone?utm_source=openai)); Bun documentation ([bun.com](https://bun.com/docs?utm_source=openai))
...
- **Meta: considering charging for next flagship model “Avocado” (possible pullback from open approach) — reported Dec 11, 2025**
  ...
  - **Source:** ([theverge.com](https://www.theverge.com/news/841809/meta-avocado-ai-model-charge-open-source-mark-zuckerberg?utm_source=openai))
...
- **Google DeepMind: UK government partnership + automated science lab planned for 2026 — reported Dec 10–11, 2025**
  ...
  - **Sources:** Financial Times ([ft.com](https://www.ft.com/content/b20f382b-ef05-4ea1-8933-df907d30cc2c?utm_source=openai)); Fortune ([fortune.com](https://fortune.com/2025/12/10/google-deepmind-uk-government-partnership-science-clean-energy//?utm_source=openai))
...
- **xAI: education-sector deployment partnership with El Salvador (Grok in public schools) — reported Dec 12, 2025**
  ...
  - **Sources:** AP ([apnews.com](https://apnews.com/article/a1c6e41b84cf5cfa8a9b20bd15dc12f3?utm_source=openai)); Guardian ([theguardian.com](https://www.theguardian.com/technology/2025/dec/11/elon-musk-el-salvador-grok?utm_source=openai))
