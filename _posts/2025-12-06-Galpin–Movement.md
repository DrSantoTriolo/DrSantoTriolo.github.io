...
---
layout: post
title: "Galpin x Huberman on Movement"
category: [Feed]
---
...
* **Hydration Assessment (WUT Status):** Check **W**eight, **U**rine color, and **T**hirst level upon waking. If 2 of 3 markers are "bad" (weight loss, dark urine, thirsty), you are hypohydrated.  
...
* **Protocol:**  
  ...
  * *Gamified Test (The Sugarcane):*  
    1. Go max distance in 2 mins. (Rest 2m).  
    2. Match that distance as fast as possible. (Rest 2m).  
    3. Go for the duration of Round 2; try to beat Round 1 distance.
