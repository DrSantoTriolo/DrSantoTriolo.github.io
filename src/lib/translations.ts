...
Throughout this entire time, they have blessed to mark the passing of each day in the richness of love and joy with family and friends. Justine calls it 'the fun times', Alex calls it 'the only memories he's ever wanted to make.'
...
We invite you to join us, family and friends old and new, to celebrate our first six years together—and all the years to come.`,
  ...
  fr: {
    ...
    about: {
      ...
      story: `Alex et Justine se sont rencontrés à Montréal à la fin du mois de février 2020. Alors que leur relation commençait tout juste à éclore, le monde semblait s'effondrer. Deux semaines après leur rencontre, la pandémie mondiale a fermé la ville, les forçant à apprendre à naviguer ensemble dans un monde entièrement nouveau. Mais, comme l'a écrit Miles Cameron, « les plus belles histoires d'amour fleurissent au cœur d'un bon siège ».
Ces premiers jours se sont passés soit dans la cuisine, à partager leur amour de la gastronomie, soit devant la télévision à regarder le parcours historique des Canadiens en 2021 vers la Coupe Stanley — une aventure qui s’est malheureusement terminée à cause de quelques erreurs inhabituelles au début du troisième match, lorsque les Habs ont accordé deux buts dans les trois premières minutes trente; puis, peu après, lorsque Josh Anderson n’a pas réussi à dégager la rondelle le long de la bande, laissant une ouverture à Rutta du Lightning pour marquer un tir parfait dans la lucarne gauche… même si Price arrêtait tout ce qui bougeait ce soir-là.

Si les premières années se sont déroulées plus calmement, les suivantes les ont vus reprendre la route, voyageant entre la Virginie, la Floride, le Maryland et les Outer Banks. Il y a eu des séjours au chalet et de la cueillette de champignons, des mariages et des « oyster roasts », des traditions des Fêtes préservées et de nouvelles créées, un feu de four (la faute de personne), plusieurs feux de barbecue (qu’Alex affirme ne pas être plus de sa faute que l’oxygène n’est responsable d’un incendie), et beaucoup, beaucoup de hockey. En mars 2023, ils ont emménagé dans un petit appartement à Little Italy. Cette même semaine, Alex a fait sa demande — avec la bague posée sur une rondelle des Canadiens.

Tout au long de ces années, ils ont eu la chance de célébrer chaque jour dans la richesse de l’amour et de la joie, entourés de leur famille et de leurs amis. Justine appelle cela « les bons moments »; Alex dit que ce sont « les seuls souvenirs qu’il ait jamais voulu créer ».
Nous vous invitons à vous joindre à nous, famille et amis, anciens et nouveaux, pour célébrer nos six premières années ensemble — et toutes celles à venir.`,
      contact: "Contact",
      email: weddingConfig.couple.email
    },
    schedule: {
