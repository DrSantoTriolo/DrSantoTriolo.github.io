...
schedule: {
  ...
  hotelsDesc: "We recommend staying closer to the city center since it's more lively and has better options for exploring Montréal. There are no hotel blocks, so feel free to book wherever suits you best! For more on lodging, see the FAQ section.",
...
Nous vous invitons, famille et amis, d’hier comme d’aujourd’hui, à venir célébrer nos six premières années ensemble — et toutes celles à venir.`,
  ...
  hotelsDesc: "Nous recommandons de loger plus près du centre-ville, c'est plus animé et idéal pour explorer Montréal. Il n'y a pas de bloc de chambres réservé, alors sentez-vous libre de réserver où bon vous semble! Pour plus d'information sur l'hébergement, voir la section FAQ.",
